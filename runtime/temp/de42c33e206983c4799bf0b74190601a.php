<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\wamp\www\fastadmin\public/../application/index\view\index\index.html";i:1510816986;}*/ ?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="col-sm-12">
                        <div class="header-content">
                            <div class="header-content-inner">
                                ...
                                <a href="/index.php/admin/index/login" class="btn btn-outline btn-xl page-scroll">登录后台</a>
                            </div>
                        </div>
                    </div>
                </div>
